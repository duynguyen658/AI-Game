...
ERROR_STATUS_MAP: dict[type[ApplicationError], int] = {
    ...
    ActionPolicyApprovalRequiredError: status.HTTP_409_CONFLICT,
    ActionPolicyReevaluationDeniedError: status.HTTP_409_CONFLICT,
    ActionStateChangedError: status.HTTP_409_CONFLICT,
